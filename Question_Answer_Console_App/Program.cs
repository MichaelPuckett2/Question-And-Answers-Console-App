...
namespace Question_Answer_Console_App
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // GetEnumerator() returns IEnumerator which has 1 property and 2 methods :: Current, MoveNext(), and Reset()
            // It basically calls GetEnumerator() and then MoveNext() and Current
